"""
Custom Window Resize Grips.

Provides edge grips (top, bottom, left, right) for resizing a frameless window.
"""
...
class CustomGrip(QWidget):
    """Invisible edge grip that enables frameless-window resizing."""
...
# ---------------------------------------------------------------------------
# Internal widget builder (mirrors Qt Designer output)
# ---------------------------------------------------------------------------

class _Widgets:
    """Creates the internal grip frames for each edge."""
